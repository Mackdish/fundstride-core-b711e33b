  ...
  component: () => (
    <ProtectedRoute roles={["super_admin","credit_officer","finance_officer","executive"]}>
      <GenericListPage config={{
        ...
        table: "loan_facilities", searchFields: ["id","account_number","product_type"], deletable: true,
        newHref: "/loans/new",
        ...
        columns: [
          { header: "Approved amount", cell: (r: any) => formatKES(r.approved_amount) },
          { header: "Rate", cell: (r: any) => formatPct(r.interest_rate) },
          { header: "Tenor", cell: (r: any) => `${r.tenor_months} mo` },
          { header: "Frequency", cell: (r: any) => r.repayment_frequency },
